...
// else if (tears === 'no' | tears === 'n') {alert ('As a matter of fact, I was born without tear ducts.');};
...
// do {
//     var guess = prompt ( name + ', can you guess a state i\'ve lived in?').toLowerCase();
//     console.log(guess);
// }
// while (!states.indexOf ( guess ));  
var states = ['idaho', 'utah', 'colorado'];

for (  var i = 6 ; i > 0 ; i--) {
   
     var guess = prompt ( name + ', can you guess what state i\'ve lived in? You have ' + i + ' guesses')
